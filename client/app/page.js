...
export default function Home() {
  ...
  return (
    <main className="flex flex-col h-screen bg-[#b9bef5] text-black items-center justify-between p-24 py-0">
      <nav className="block text-lg w-full max-w-screen-xl px-4 py-0 mx-auto  bg-white bg-inherit rounded-xl backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-8">
