...
export default function Home() {
  ...
  return (
    <main className="flex flex-col h-screen bg-[#b9bef5] text-black items-center justify-between p-24 py-0">
      <nav className="block text-lg w-full max-w-screen-xl px-4 py-0 mx-auto  bg-inherit rounded-xl backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-8">
  <div className="container flex items-center justify-between mx-auto text-blue-gray-900">
    <a href="#"
      className="mr-4 block cursor-pointer font-sans text-2xl font-medium leading-relaxed text-inherit antialiased">
      LedgerAI
    </a>
    <div className="hidden mx-2 lg:block">
      <ul className="font-normal flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        <li
          className="flex items-center p-1 font-sans antialiased  leading-normal gap-x-2 text-blue-gray-900">
        ...
        <li
          ...
          <a href="/internal" className="flex items-center">
            INTRA-COMPANY
          </a>
        </li>
      </ul>
    ...
    <div className="flex items-center gap-x-1">
      <button
        ...
        className="hidden px-4 py-2 font-sans font-bold text-center text-gray-900 uppercase align-middle transition-all rounded-lg select-none hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
        type="button">
        <span>Log In</span>
      </button>
      <button
          onClick={() => router.push("/signup")}
        className="hidden ml-1 select-none rounded-xl bg-gradient-to-tr from-[#4e5587] to-gray-800 py-2 px-4 text-center align-middle font-sans font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
        type="button">
        <span>Sign Up</span>
      </button>
    </div>
    <button
      className="relative ml-auto h-6 max-h-[40px] w-6 max-w-[40px] select-none rounded-xl text-center align-middle font-sans text-xs font-medium uppercase text-inherit transition-all hover:bg-transparent focus:bg-transparent active:bg-transparent disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:hidden"
      type="button">
      ...
      <div className="flex flex-col justify-center items-center my-auto">
        <div>
            <p className="text-5xl font-extrabold">Automate your accounting workflow</p>
            <p className="py-3 text-center text-lg">Empower your B2B journey with AI-driven Accounts Automation, transforming the way you work!</p>
            <button onClick={() => router.push('./signin')} className="flex flex-row my-6 justify-center items-center mx-auto w-[1/2] rounded-xl py-4 px-6 text-center bg-slate-100 align-middle font-sans font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] ">
             <h2 className="bg-gradient-to-tr from-[#4e5587] to-gray-800 inline-block text-transparent bg-clip-text">Get Started</h2> 
            </button>
        </div>
