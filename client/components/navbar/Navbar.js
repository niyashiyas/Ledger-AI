...
export default function Navbar() {
  ...
  return (
    <main className="flex flex-col h-screen bg-[#b9bef5] text-black items-center justify-between p-24 py-0">
      <nav className="block text- w-full max-w-screen-xl px-4 py-0 mx-auto bg-inherit rounded-xl backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-8">
  <div className="container flex items-center justify-between mx-auto text-blue-gray-900">
    ...
    <div className="hidden mx-0 lg:block">
    ...
    <div className="flex items-center gap-x-1">
      <button
        ...
        className="hidden px-4 py-2 font-sans font-bold text-center text-gray-900 align-middle transition-all rounded-lg select-none hover:bg-gray-900/10 active:bg-gray-900/20 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block">
