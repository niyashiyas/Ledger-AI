...
export default function Auth() {
  ...
  return (
    <div className="bg-[#dee1fa] h-screen flex flex-col gap-4 items-center justify-center text-black">
      ...
      <button className="border-2 border-balck rounded-lg p-1 px-4 bg-gradient-to-tr from-[#4e5587] to-gray-800 text-white hover:text-slate-200 w-1/6" onClick={() => {router.push('./dashboard')}}>Log In</button>
