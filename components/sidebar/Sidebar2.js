  ...
  const handleLogout = async () => {
    ...
    return (
        <div id="div1" className="div1 flex flex-col items-center w-[13%] pt-0 h-full overflow-hidden text-gray-400 bg-white ml-0 z-10 fixed">
            ...
            <a className="flex items-center w-[150px] h-12 mb-2 hover:text-white hover:bg-[#FFCB0A] rounded-xl" href="/wmdetails">
            ...
            <a className="flex items-center w-[150px] h-12 mb-2 hover:text-white hover:bg-[#FFCB0A] rounded-xl" href="/payment">
                <div className="flex py-4 pl-4 gap-2">
                    <img className="w-6 h-6" src="./logo-images/News-nav.svg" />
                    <span className="text-md font-medium">Payment</span>
                </div>
            </a>
